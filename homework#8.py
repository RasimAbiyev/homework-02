...
# C. What is the purpose of 0using constants like ascii_letters from the string module in Python programming?
# Readability and Maintainability, Consistency, Avoiding Magic Numbers, Internationalization, Convenience
...
print(round(math.sqrt(number), 1))
...
apples = 28
ate_apples = 4
remaining_apples = apples - ate_apples
percentage_left = (remaining_apples / apples) * 100
...
original_string = "My name is Rasim"
